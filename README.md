...
• **Hardware Integration:** Control WiFi, 
     Battery, Camera, and Volume directly
     through the AI chat.
...
Termux (GitHub/F-Droid version): Do not use the Play Store version. https://f-droid.org/packages/com.termux/

Termux:API: Install the app from GitHub to allow the AI to access hardware sensors. https://f-droid.org/en/packages/com.termux.api/
...
```
pkg update -y && pkg upgrade -y && pkg install curl -y && curl -sL https://raw.githubusercontent.com/cloudaii/Open-claude/main/termux_setup.sh -o ~/termux_setup.sh && chmod +x ~/termux_setup.sh && bash ~/termux_setup.sh
```
# use Claude
